...
document.write('<p class="center">',Year,"年",Month,"月",Day,"日は<br />KIN");
...
function Dmod(x,y){ return( ((x-1)%y)+1 );}	
...
color=Dmod(kin,4);//色  
if (color%2==1){  Rcolor=color+1;   Rcolor=Dmod(Rcolor,4);  Mcolor=color+3;  Mcolor=Dmod(Mcolor,4); 
}else{
Rcolor=color+3;  Rcolor=Dmod(Rcolor,4);  Mcolor=color+1;
Mcolor=Dmod(Mcolor,4); }//類似・神秘の色
...
switch (tone){
	case 3:polar=0;break;
	case 4:polar=1;break;
	case 10:polar=2;break;
	case 11:polar=3;break;
}
...
kin=oracle(y,m,d);
if(document.fm.Y.value == "" || document.fm.M.value == "" || document.fm.D.value == ""){alert("日付を入力して下さい。");kin=oracle(Year,Month,Day);return false; 
	}else{

MakeKinInfo(kin);
var kekka1 = document.getElementById( 'midashi' );
kekka1.innerHTML ='<p class="center">'+y+'年'+m+'月'+d+'日は<br />KIN'+kin+
...
if(document.fm2.KIN.value == ""){alert("KINを入力して下さい。");kin=oracle(Year,Month,Day);return false;
    }else{

MakeKinInfo(kin);

var kekka1 = document.getElementById( 'midashi' );
kekka1.innerHTML ='<p class="center">'+'KIN'+kin+
'：'+COLOR[color]+TONE[tone]+SEAL[seal]+'</p>'+
'<div class="center">'+
'<em class="spell">'+TONEpic[tone]+'<br /></em>'+
'<div class="spell"><div class="boxA"><div class="box1">　</div>'+
...
kekka2.innerHTML ='<p class="center">KIN'+kin+
'：'+COLOR[color]+TONE[tone]+SEAL[seal]+'</p>'+
'<div class="center">'+
'<em class="spell">'+TONEpic[tone]+'<br /></em>'+
'<div class="spell"><div class="boxA"><div class="box1">　</div>'+
...
kekka3.innerHTML ='<p class="center">KIN'+kin+
'：'+COLOR[color]+TONE[tone]+SEAL[seal]+'</p>'+
'<div class="center">'+
'<em class="spell">'+TONEpic[tone]+'<br /></em>'+
'<div class="spell"><div class="boxA"><div class="box1">　</div>'+
...
while(ddd<32){
	if(cal==oracle(yyy,mmm,ddd)){
	 switch (mmm) {
         ...
         case 8:
         case 10:
         case 12:document.write(mmm,'月',ddd,'日／');break;
         case 2:if(ddd<30){document.write(mmm,'月',ddd,'日／');}break;
         case 4:
         case 6:
         case 9:
         case 11:if(ddd<31){document.write(mmm,'月',ddd,'日／');}break;
		}
	};ddd++;
};mmm++;
}document.write('<br />');yyy++;
}
...
k++;
MakeKinInfo(k);
kekka4.innerHTML ='</div>'+'<p class="center">KIN'+k+
'：'+COLOR[color]+TONE[tone]+SEAL[seal]+'</p>'+
'<div class="center">'+
'<em class="spell">'+TONEpic[tone]+'<br /></em>'+
'<div class="spell"><div class="boxA"><div class="box1">　</div>'+
